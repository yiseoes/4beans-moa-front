            ...
            >
              ...
              {party.memberStatus === 'INACTIVE' ? (
                ...
                <motion.button
                  ...
                  className={`w-full py-3.5 text-white rounded-full font-semibold shadow-lg transition-all flex items-center justify-center gap-2 ${
                    theme === "christmas"
              ...
              >
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                    <Lock className={`w-5 h-5 ${theme === "christmas" ? "text-red-800" : "text-[#635bff]"}`} />
                    계정 정보
                  </h2>
                  {isLeader && (
                    <button
                      onClick={() => setIsOttModalOpen(true)}
                      className={`text-xs bg-white hover:bg-gray-50 px-4 py-2 rounded-full border transition font-semibold ${
                        theme === "christmas"
                          ? "text-red-800 border-gray-200"
                          : "text-[#635bff] border-[#635bff]/20"
                      }`}
                    >
                      수정
                    </button>
                ...
                <motion.button
                  ...
                  className={`w-full py-3 bg-white hover:bg-gray-50 border rounded-xl font-semibold transition-all flex items-center justify-center gap-2 ${
                    theme === "christmas"
                      ? "text-red-800 border-gray-200"
                      : "text-[#635bff] border-[#635bff]/20"
                  }`}
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <motion.button
                  ...
                  className={`flex-1 py-3.5 text-white rounded-full font-semibold shadow-lg transition-all ${
                    theme === "christmas"
                      ? "bg-red-800 hover:bg-red-900 shadow-red-800/25"
                      : "bg-[#635bff] hover:bg-[#5851e8] shadow-[#635bff]/25"
                  }`}
