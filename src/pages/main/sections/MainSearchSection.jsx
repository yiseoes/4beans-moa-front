        ...
        <div className="flex flex-wrap gap-2 justify-center mt-6">
          {["넷플릭스", "디즈니+", "유튜브", "스포티파이", "웨이브"].map((tag) => (
            <button
              ...
              className={`px-4 py-2 border rounded-full font-bold text-sm transition-all ${isDark ? 'bg-slate-700 border-gray-600 text-white hover:bg-pink-900 hover:border-pink-500' : 'bg-slate-100 border-gray-200 hover:bg-pink-100 hover:border-pink-500'}`}
            >
              {tag}
            </button>
          ))}
