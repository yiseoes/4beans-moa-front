...
/**
 * LandingPageO3 - "Neo-Brutalist Pop (Calm Edition)"
 *
 * Design Direction:
 * - Same Pop & Vibrant feel as Variant O
 * - Neo-brutalist aesthetic with bold borders and shadows
 * - Vibrant color palette: Hot Pink, Lime, Cyan (same as O)
 * - BUT with calm, neutral backgrounds (white/gray instead of yellow)
...
export default function LandingPageO3() {
  const features = [
    {
      icon: Users,
      title: "파티 공유",
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-black overflow-hidden">
      ...
      {/* Features Section - Calm White Background */}
      <section className="relative px-6 md:px-12 py-24 bg-white border-b-4 border-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <Sticker color="bg-lime-400" rotate={-2} className="inline-block px-6 py-3 rounded-xl mb-6">
      ...
      {/* Party Preview Section - Calm Slate Background */}
      <section className="relative px-6 md:px-12 py-24 bg-slate-100 border-b-4 border-black">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              <BouncyCard key={i} delay={i * 0.1}>
                ...
                <div className={`h-36 ${i % 4 === 0 ? 'bg-red-500' : i % 4 === 1 ? 'bg-blue-500' : i % 4 === 2 ? 'bg-indigo-500' : 'bg-pink-500'} flex items-center justify-center relative`}>
                  ...
                  <div className="absolute top-3 left-3">
                    <Sticker color="bg-cyan-400" rotate={-3} className="px-2 py-1 rounded-lg">
      ...
      {/* CTA Section - Calm Gray Background */}
      <section className="relative px-6 md:px-12 py-24 bg-slate-100">
      ...
      <footer className="bg-black text-white px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <Sticker color="bg-pink-500" rotate={-3} className="px-3 py-1 rounded-lg">
