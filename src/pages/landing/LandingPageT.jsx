...
const FeatureCard = ({ icon: Icon, title, description, color, delay = 0 }) => (
    <motion.div
        ...
        className="group p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-gray-200 transition-all duration-300"
    >
        <div
...
const PricingCard = ({ title, price, features, popular, delay = 0 }) => (
    ...
    >
        {popular && (
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-[#635bff] to-[#00d4ff] text-white text-sm font-semibold rounded-full">
                Most Popular
            </div>
        )}

        <div className="text-center mb-8">
            <h3 className={`text-lg font-semibold mb-2 ${popular ? "text-gray-300" : "text-gray-500"}`}>
                {title}
            </h3>
            <div className="flex items-baseline justify-center gap-1">
                <span className="text-4xl font-black">{price}</span>
                <span className={`text-sm ${popular ? "text-gray-400" : "text-gray-500"}`}>원/월</span>
            </div>
        </div>
        ...
        <ul className="space-y-4 mb-8">
            {features.map((feature, i) => (
                <li key={i} className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center ${popular ? "bg-[#635bff]" : "bg-green-500"}`}>
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 overflow-hidden">
            ...
            <motion.header
                ...
                className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-gray-100/50"
            >
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-black text-gray-900">MoA</span>
                        </Link>
                ...
                <div className="relative max-w-7xl mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-[#635bff]/10 rounded-full mb-8"
                        >
                        ...
                        >
                            <span className="text-gray-900">스마트하게 공유하고</span>
                            <br />
                    ...
                    >
                        ...
                        <div className="relative mx-auto max-w-5xl">
                            <div className="absolute -inset-4 bg-gradient-to-r from-[#635bff]/20 via-[#00d4ff]/20 to-[#635bff]/20 rounded-3xl blur-2xl" />
                            <div className="relative bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden">
                                ...
                                <div className="flex items-center gap-2 px-4 py-3 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <div className="flex-1 flex justify-center">
                                        <div className="px-4 py-1 bg-white rounded-full text-sm text-gray-500 border border-gray-200">
                                            moa.app/party
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
                        {OTT_SERVICES.map((service, i) => (
                            ...
                            >
                                ...
                                <span className="text-gray-600 font-medium hidden sm:block">{service.name}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <motion.span
                            ...
                            whileInView={{ opacity: 1 }}
                            viewport={{ once: true }}
                            className="inline-block px-4 py-1 bg-[#635bff]/10 rounded-full text-sm font-semibold text-[#635bff] mb-4"
                        >
                            Features
                        </motion.span>
                        <motion.h2
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        {/* Connecting Line */}
                        <div className="hidden md:block absolute top-24 left-[calc(16.67%+2rem)] right-[calc(16.67%+2rem)] h-0.5 bg-gradient-to-r from-[#635bff] via-[#00d4ff] to-[#635bff]" />
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <nav className="flex items-center gap-6 text-sm text-gray-600">
                            ...
                            <Link to="/community/faq" className="hover:text-gray-900 transition-colors">자주 묻는 질문</Link>
