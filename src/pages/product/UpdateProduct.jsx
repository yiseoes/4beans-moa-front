...
const UpdateProduct = () => {
    ...
    const themeStyle = updateProductThemeStyles[theme] || updateProductThemeStyles.default;
    const { id } = useParams();
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl relative">
            ...
            <h1 className="text-3xl font-bold mb-2 text-stone-900">상품 정보 수정</h1>
            <p className="text-stone-500 mb-8">관리자 권한으로 기존 구독 상품 정보를 수정합니다.</p>
