            ...
            <CardContent className="py-12 px-6">
                <div className="text-center">
                    ...
                    >
                        ...
                        />
                        {/* 메인 아이콘 */}
                        <div className="absolute inset-0 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center shadow-lg shadow-orange-200">
                            <motion.div
                                animate={{ rotate: 360 }}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={`
                                        ...
                                        ${status === 'processing' ? 'text-orange-600 font-medium' : ''}
