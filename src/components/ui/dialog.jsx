...
const DialogOverlay = React.forwardRef(({ className, allowScroll = false, ...props }, ref) => (
...
const DialogContent = React.forwardRef(({ className, children, allowScroll = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className={allowScroll ? "pointer-events-none" : ""} />
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        allowScroll && "pointer-events-auto",
        className
      )}
      {...props}>
      {children}
